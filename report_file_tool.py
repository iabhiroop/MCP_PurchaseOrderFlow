...
class ReportFileTool:
    ...
    def save_report(self, file_path: str, data: str, 
...
if __name__ == "__main__":
    ...
    test_data = "This is a test report with some sample data."
    result = tool.save_report("data/test_report.txt", test_data, add_timestamp=True)
    print(result)
