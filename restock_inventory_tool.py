...
class RestockInventoryTool:
    ...
    def __init__(self):
        ...
        self.db_path = os.path.join(project_root, "data", "inventory.db")
    ...
    def analyze_inventory(self, analysis_type: str, category: str = "", urgency_level: str = "all") -> str:
        """
...
if __name__ == "__main__":
    ...
    print("=== Restock Inventory Tool Test ===")
    print("\n1. Items needing restock:")
    print(tool.analyze_inventory("restock_needed", urgency_level="all"))
    print("\n2. Inventory status:")
    print(tool.analyze_inventory("inventory_status"))
