...
# Remove the CrewAI BaseTool dependency and create a regular class
class DocumentGenerator:
    """Document generator class that handles PDF and LaTeX generation"""
    
    def __init__(self):
        self.name = "DocumentGenerator"
        self.description = (
    ...
    def create_pdf_purchase_order(self, supplier_name: str, items: List[Dict], 
        ...
        try:
            ...
            latex_content = self.create_latex_purchase_order(
    ...
    def create_latex_purchase_order(self, supplier_name: str, items: List[Dict], 
                                   delivery_date: str, delivery_address: str, contact_person: str,
                                   contact_email: str, special_instructions: str, po_number: str) -> str:
