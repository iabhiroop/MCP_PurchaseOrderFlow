...
class PORecordTool:
    """Comprehensive PO processing system that records orders in MongoDB database"""
    
    def __init__(self):
        self.name = "PO Record Management System"
        self.description = (
            ...
            "2. 'record_single_po' - Save a single PO\n" 
            "3. 'get_order_status' - Get status of an order by ID\n"
    ...
    def manage_po_records(self, action: str, extracted_data: 'str | dict' = None, 
                         po_data: 'str | dict' = None, order_id: str = None) -> str:
        """
        ...
        Parameters:
            action (str): The action to perform. Supported actions are:
                ...
                - "record_single_po": Record a single PO
                - "get_order_status": Get order status by ID
            extracted_data (str or dict): The extracted data containing orders and metadata.
            po_data (str or dict): Single PO data for record_single_po action
            order_id (str): Order ID for get_order_status action
        """
        try:
...
if __name__ == "__main__":
    ...
    result = tool.manage_po_records("record_single_po", po_data=test_po)
    print(result)
