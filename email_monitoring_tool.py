...
class EmailMonitoringTool:
    """Email monitoring tool that fetches unread emails with attachments"""
    
    def __init__(self):
        self.name = "EmailMonitoringTool"
        self.description = (
    ...
    def fetch_emails(self) -> str:
        ...
        try:
            ...
            if not user or not password:
                return json.dumps({
                    "status": "error",
                    "message": "Email credentials not found. Please set 'supemail' and 'suppassword' in environment variables."
                })
...
if __name__ == "__main__":
    # Test the EmailMonitoringTool
    tool = EmailMonitoringTool()
    result = tool.fetch_emails()
    print(result)
