...
class FinancialDataTool:
    """Financial tool focused on procurement approval and budget validation"""
    ...
    def get_financial_data(self, query_type: str, amount: float = 0.0) -> str:
        """
...
if __name__ == "__main__":
    ...
    print(tool.get_financial_data(query_type="approval_limits", amount=75000))
    
    print("\n=== Procurement Budget Check ===")
    print(tool.get_financial_data(query_type="procurement_budget", amount=150000))
    
    print("\n=== Large Amount (should require board approval) ===")
    print(tool.get_financial_data(query_type="approval_limits", amount=6000000))
