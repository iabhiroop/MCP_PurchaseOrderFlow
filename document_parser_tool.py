...
class DocumentParser:
    """Document parser class that extracts structured purchase order data from documents"""
    
    def __init__(self):
        self.name = "DocumentParser"
        self.description = (
            "Extract structured purchase order data from documents using PaddleOCR and Gemini API. "
    ...
    def parse_document(self, file_path: str, action: str = "extract_po_data") -> str:
        """
    ...
    def _extract_po_data(self, file_path: str) -> str:
        """Extract purchase order data from document using PaddleOCR and Gemini API"""
        try:
            ocr = PaddleOCR(
...
if __name__ == "__main__":
    ...
    result = tool.parse_document(file_path=file_path, action=action)
    print(result)
