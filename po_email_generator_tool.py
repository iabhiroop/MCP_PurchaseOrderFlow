...
class POEmailGenerator:
    """Purchase order email generator for sending professional emails to suppliers"""
    
    def __init__(self):
        self.name = "POEmailGenerator"
        self.description = (
    ...
    def generate_po_email(self, action: str = "send_po_email", supplier_email: str = "", 
                         supplier_name: str = "", po_number: str = "", po_data: Dict = {}, 
                         po_file_path: str = "", delivery_date: str = "", 
                         special_instructions: str = "", cc_emails: List[str] = [], 
        ...
        try:
            ...
            return f"Error in POEmailGenerator: {str(e)}"
